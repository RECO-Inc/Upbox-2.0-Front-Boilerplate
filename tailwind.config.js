  	...
  	extend: {
  		...
  		fontSize: {
  			'size-9': [
  				'var(--text-size-9)',
  				{
  					lineHeight: 'var(--text-size-9--line-height)'
  				}
  			],
  			'size-10': [
  				'var(--text-size-10)',
  				{
  					lineHeight: 'var(--text-size-10--line-height)'
  				}
  			],
  			'size-11': [
  				'var(--text-size-11)',
  				{
  					lineHeight: 'var(--text-size-11--line-height)'
  				}
  			],
  			'size-12': [
  				'var(--text-size-12)',
  				{
  					lineHeight: 'var(--text-size-12--line-height)'
  				}
  			],
  			'size-13': [
  				'var(--text-size-13)',
  				{
  					lineHeight: 'var(--text-size-13--line-height)'
  				}
  			],
  			'size-14': [
  				'var(--text-size-14)',
  				{
  					lineHeight: 'var(--text-size-14--line-height)'
  				}
  			],
  			'size-15': [
  				'var(--text-size-15)',
  				{
  					lineHeight: 'var(--text-size-15--line-height)'
  				}
  			],
  			'size-16': [
  				'var(--text-size-16)',
  				{
  					lineHeight: 'var(--text-size-16--line-height)'
  				}
  			],
  			'size-18': [
  				'var(--text-size-18)',
  				{
  					lineHeight: 'var(--text-size-18--line-height)'
  				}
  			],
  			'size-20': [
  				'var(--text-size-20)',
  				{
  					lineHeight: 'var(--text-size-20--line-height)'
  				}
  			],
  			'size-22': [
  				'var(--text-size-22)',
  				{
  					lineHeight: 'var(--text-size-22--line-height)'
  				}
  			],
  			'size-24': [
  				'var(--text-size-24)',
  				{
  					lineHeight: 'var(--text-size-24--line-height)'
  				}
  			],
  			'size-28': [
  				'var(--text-size-28)',
  				{
  					lineHeight: 'var(--text-size-28--line-height)'
  				}
  			],
  			'size-32': [
  				'var(--text-size-32)',
  				{
  					lineHeight: 'var(--text-size-32--line-height)'
  				}
  			]
  		},
  		fontWeight: {
